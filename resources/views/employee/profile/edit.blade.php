                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div
                                class="mt-1 rounded-md border border-gray-300 bg-gray-50 p-4 text-sm text-gray-600 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300"
                            >
                                {{ $profile->cv_path
                                    ? __('CV uploaded')
                        ...
                        <div>
                            <x-input-label
                                for="application_image_path"
                                :value="__('Application Image')"
                            />
