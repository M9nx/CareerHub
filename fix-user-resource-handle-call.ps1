# PowerShell script to update UserResource.php to call BlockUserFromPosts::handle()
# Run this from the root of your Laravel project.

$ErrorActionPreference = "Stop"

$dir1 = "app\Filament\SuperAdmin\Resources"
...
$userResourcePath = Join-Path (Resolve-Path $dir1) "UserResource.php"
[System.IO.File]::WriteAllText($userResourcePath, $userResourceContent, $utf8NoBom)

Write-Host "Done:"
Write-Host " - $dir1\UserResource.php"
